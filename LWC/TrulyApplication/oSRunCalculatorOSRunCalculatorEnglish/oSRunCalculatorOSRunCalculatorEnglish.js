...
import { OMNIDEF } from './oSRunCalculatorOSRunCalculatorEnglish_def.js';
import tmpl from './oSRunCalculatorOSRunCalculatorEnglish.html';
import tmpl_nds from './oSRunCalculatorOSRunCalculatorEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oSRunCalculatorOSRunCalculatorEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
